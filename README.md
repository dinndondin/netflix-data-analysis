...
* **`analisis.py`**: *(Script principal de Python)*.
...
* **LinkedIn**: [geraldineramosc](https://www.linkedin.com/in/geraldineramosc/)
* **GitHub**: [dinndondin](https://github.com/dinndondin/netflix-data-analysis)
